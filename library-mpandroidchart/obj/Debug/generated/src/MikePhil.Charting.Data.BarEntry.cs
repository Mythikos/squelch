...
namespace MikePhil.Charting.Data {
	...
	public partial class BarEntry : global::MikePhil.Charting.Data.Entry {
		...
		[Register (".ctor", "(FF)V", "")]
		public unsafe BarEntry (float x, float y) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
		...
		public unsafe BarEntry (float x, float y, global::Android.Graphics.Drawables.Drawable icon) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
		...
		public unsafe BarEntry (float x, float y, global::Android.Graphics.Drawables.Drawable icon, global::Java.Lang.Object data) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
		...
		public unsafe BarEntry (float x, float y, global::Java.Lang.Object data) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.github.mikephil.charting.data']/class[@name='BarEntry']/constructor[@name='BarEntry' and count(parameter)=2 and parameter[1][@type='float'] and parameter[2][@type='float[]']]"
		[Register (".ctor", "(F[F)V", "")]
		public unsafe BarEntry (float x, float[] vals) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
		...
		public unsafe BarEntry (float x, float[] vals, global::Android.Graphics.Drawables.Drawable icon) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
		...
		public unsafe BarEntry (float x, float[] vals, global::Android.Graphics.Drawables.Drawable icon, global::Java.Lang.Object data) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
		...
		public unsafe BarEntry (float x, float[] vals, global::Java.Lang.Object data) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::MikePhil.Charting.Data.BarEntry> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning disable 0169
		static Delegate GetGetNegativeSumHandler ()
		{
			if (cb_getNegativeSum == null)
				cb_getNegativeSum = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_F) n_GetNegativeSum);
...
#pragma warning disable 0169
		static Delegate GetGetPositiveSumHandler ()
		{
			if (cb_getPositiveSum == null)
				cb_getPositiveSum = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_F) n_GetPositiveSum);
...
#pragma warning disable 0169
		static Delegate GetCalcRangesHandler ()
		{
			if (cb_calcRanges == null)
				cb_calcRanges = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_V) n_CalcRanges);
...
#pragma warning disable 0169
		...
		static Delegate GetGetBelowSum_IHandler ()
		{
			if (cb_getBelowSum_I == null)
				cb_getBelowSum_I = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPI_F) n_GetBelowSum_I);
...
#pragma warning disable 0169
		static Delegate GetGetRangesHandler ()
		{
			if (cb_getRanges == null)
				cb_getRanges = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_GetRanges);
			return cb_getRanges;
		}
...
#pragma warning disable 0169
		static Delegate GetGetSumBelow_IHandler ()
		{
			if (cb_getSumBelow_I == null)
				cb_getSumBelow_I = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPI_F) n_GetSumBelow_I);
...
#pragma warning disable 0169
		...
		{
			if (cb_getYVals == null)
				cb_getYVals = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_GetYVals);
			return cb_getYVals;
		}
...
#pragma warning disable 0169
		static Delegate GetSetVals_arrayFHandler ()
		{
			if (cb_setVals_arrayF == null)
				cb_setVals_arrayF = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPL_V) n_SetVals_arrayF);
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::MikePhil.Charting.Data.BarEntry> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			var vals = (float[]) JNIEnv.GetArray (native_vals, JniHandleOwnership.DoNotTransfer, typeof (float));
			__this.SetVals (vals);
			if (vals != null)
