...
namespace MikePhil.Charting.Interfaces.Datasets {
	...
	internal class IBubbleDataSetInvoker : global::Java.Lang.Object, IBubbleDataSet {
		...
		public static IBubbleDataSet GetObject (IntPtr handle, JniHandleOwnership transfer)
		{
			return global::Java.Lang.Object.GetObject<IBubbleDataSet> (handle, transfer);
		}
		...
		public IBubbleDataSetInvoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
		{
...
#pragma warning restore 0169
		...
		IntPtr id_getHighlightCircleWidth;
		IntPtr id_setHighlightCircleWidth_F;
		public unsafe float HighlightCircleWidth {
			get {
				if (id_getHighlightCircleWidth == IntPtr.Zero)
					id_getHighlightCircleWidth = JNIEnv.GetMethodID (class_ref, "getHighlightCircleWidth", "()F");
				return JNIEnv.CallFloatMethod (((global::Java.Lang.Object) this).Handle, id_getHighlightCircleWidth);
			}
			set {
				if (id_setHighlightCircleWidth_F == IntPtr.Zero)
					id_setHighlightCircleWidth_F = JNIEnv.GetMethodID (class_ref, "setHighlightCircleWidth", "(F)V");
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (value);
				JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_setHighlightCircleWidth_F, __args);
			}
		}
...
#pragma warning restore 0169
		...
		IntPtr id_isNormalizeSizeEnabled;
		public unsafe bool IsNormalizeSizeEnabled {
			get {
				if (id_isNormalizeSizeEnabled == IntPtr.Zero)
					id_isNormalizeSizeEnabled = JNIEnv.GetMethodID (class_ref, "isNormalizeSizeEnabled", "()Z");
				return JNIEnv.CallBooleanMethod (((global::Java.Lang.Object) this).Handle, id_isNormalizeSizeEnabled);
			}
		}
		...
		public unsafe float MaxSize {
			get {
				if (id_getMaxSize == IntPtr.Zero)
					id_getMaxSize = JNIEnv.GetMethodID (class_ref, "getMaxSize", "()F");
				return JNIEnv.CallFloatMethod (((global::Java.Lang.Object) this).Handle, id_getMaxSize);
			}
		}
