...
namespace MikePhil.Charting.Renderer.Scatter {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.github.mikephil.charting.renderer.scatter']/class[@name='XShapeRenderer']"
	[global::Android.Runtime.Register ("com/github/mikephil/charting/renderer/scatter/XShapeRenderer", DoNotGenerateAcw=true)]
	public partial class XShapeRenderer : global::Java.Lang.Object, global::MikePhil.Charting.Renderer.Scatter.IShapeRenderer {

		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("com/github/mikephil/charting/renderer/scatter/XShapeRenderer", typeof (XShapeRenderer));
		...
		protected XShapeRenderer (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.github.mikephil.charting.renderer.scatter']/class[@name='XShapeRenderer']/constructor[@name='XShapeRenderer' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe XShapeRenderer ()
...
#pragma warning disable 0169
		...
		{
			global::MikePhil.Charting.Renderer.Scatter.XShapeRenderer __this = global::Java.Lang.Object.GetObject<global::MikePhil.Charting.Renderer.Scatter.XShapeRenderer> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
