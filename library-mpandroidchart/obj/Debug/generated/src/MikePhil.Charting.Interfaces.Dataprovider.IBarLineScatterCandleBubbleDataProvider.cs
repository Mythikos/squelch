...
namespace MikePhil.Charting.Interfaces.Dataprovider {
	...
	public partial interface IBarLineScatterCandleBubbleDataProvider : global::MikePhil.Charting.Interfaces.Dataprovider.IChartInterface {
		...
		float HighestVisibleX {
			...
			[Register ("getHighestVisibleX", "()F", "GetGetHighestVisibleXHandler:MikePhil.Charting.Interfaces.Dataprovider.IBarLineScatterCandleBubbleDataProviderInvoker, library-mpandroidchart")] get;
		}
		...
		float LowestVisibleX {
			...
			[Register ("getLowestVisibleX", "()F", "GetGetLowestVisibleXHandler:MikePhil.Charting.Interfaces.Dataprovider.IBarLineScatterCandleBubbleDataProviderInvoker, library-mpandroidchart")] get;
		}
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "com.github.mikephil.charting.interfaces.dataprovider.BarLineScatterCandleBubbleDataProvider"));
			return handle;
		}
...
#pragma warning disable 0169
		...
		{
			global::MikePhil.Charting.Interfaces.Dataprovider.IBarLineScatterCandleBubbleDataProvider __this = global::Java.Lang.Object.GetObject<global::MikePhil.Charting.Interfaces.Dataprovider.IBarLineScatterCandleBubbleDataProvider> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
