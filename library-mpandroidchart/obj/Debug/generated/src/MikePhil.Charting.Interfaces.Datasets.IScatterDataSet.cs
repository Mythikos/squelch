...
namespace MikePhil.Charting.Interfaces.Datasets {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='com.github.mikephil.charting.interfaces.datasets']/interface[@name='IScatterDataSet']"
	[Register ("com/github/mikephil/charting/interfaces/datasets/IScatterDataSet", "", "MikePhil.Charting.Interfaces.Datasets.IScatterDataSetInvoker")]
	public partial interface IScatterDataSet : global::MikePhil.Charting.Interfaces.Datasets.ILineScatterCandleRadarDataSet {
		int ScatterShapeHoleColor {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.github.mikephil.charting.interfaces.datasets']/interface[@name='IScatterDataSet']/method[@name='getScatterShapeHoleColor' and count(parameter)=0]"
			[Register ("getScatterShapeHoleColor", "()I", "GetGetScatterShapeHoleColorHandler:MikePhil.Charting.Interfaces.Datasets.IScatterDataSetInvoker, library-mpandroidchart")]
			get; 
		}

		float ScatterShapeHoleRadius {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.github.mikephil.charting.interfaces.datasets']/interface[@name='IScatterDataSet']/method[@name='getScatterShapeHoleRadius' and count(parameter)=0]"
			[Register ("getScatterShapeHoleRadius", "()F", "GetGetScatterShapeHoleRadiusHandler:MikePhil.Charting.Interfaces.Datasets.IScatterDataSetInvoker, library-mpandroidchart")]
			get; 
		}

		float ScatterShapeSize {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.github.mikephil.charting.interfaces.datasets']/interface[@name='IScatterDataSet']/method[@name='getScatterShapeSize' and count(parameter)=0]"
			[Register ("getScatterShapeSize", "()F", "GetGetScatterShapeSizeHandler:MikePhil.Charting.Interfaces.Datasets.IScatterDataSetInvoker, library-mpandroidchart")]
			get; 
		}

		global::MikePhil.Charting.Renderer.Scatter.IShapeRenderer ShapeRenderer {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.github.mikephil.charting.interfaces.datasets']/interface[@name='IScatterDataSet']/method[@name='getShapeRenderer' and count(parameter)=0]"
			[Register ("getShapeRenderer", "()Lcom/github/mikephil/charting/renderer/scatter/IShapeRenderer;", "GetGetShapeRendererHandler:MikePhil.Charting.Interfaces.Datasets.IScatterDataSetInvoker, library-mpandroidchart")]
			get; 
		}
	...
	internal partial class IScatterDataSetInvoker : global::Java.Lang.Object, IScatterDataSet {
		...
		public static IScatterDataSet GetObject (IntPtr handle, JniHandleOwnership transfer)
		{
			return global::Java.Lang.Object.GetObject<IScatterDataSet> (handle, transfer);
		}

		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException ($"Unable to convert instance of type '{JNIEnv.GetClassNameFromInstance (handle)}' to type 'com.github.mikephil.charting.interfaces.datasets.IScatterDataSet'.");
			return handle;
		}
		...
		public IScatterDataSetInvoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
		{
...
#pragma warning disable 0169
		static Delegate GetGetScatterShapeHoleColorHandler ()
		{
			if (cb_getScatterShapeHoleColor == null)
				cb_getScatterShapeHoleColor = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_I) n_GetScatterShapeHoleColor);
			return cb_getScatterShapeHoleColor;
		}

		static int n_GetScatterShapeHoleColor (IntPtr jnienv, IntPtr native__this)
		{
			var __this = global::Java.Lang.Object.GetObject<global::MikePhil.Charting.Interfaces.Datasets.IScatterDataSet> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.ScatterShapeHoleColor;
		}
#pragma warning restore 0169

		IntPtr id_getScatterShapeHoleColor;
		public unsafe int ScatterShapeHoleColor {
			get {
				if (id_getScatterShapeHoleColor == IntPtr.Zero)
					id_getScatterShapeHoleColor = JNIEnv.GetMethodID (class_ref, "getScatterShapeHoleColor", "()I");
				return JNIEnv.CallIntMethod (((global::Java.Lang.Object) this).Handle, id_getScatterShapeHoleColor);
			}
		}
...
#pragma warning disable 0169
		static Delegate GetGetScatterShapeHoleRadiusHandler ()
		{
			if (cb_getScatterShapeHoleRadius == null)
				cb_getScatterShapeHoleRadius = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_F) n_GetScatterShapeHoleRadius);
...
#pragma warning restore 0169
		...
		IntPtr id_getScatterShapeHoleRadius;
		public unsafe float ScatterShapeHoleRadius {
			get {
				if (id_getScatterShapeHoleRadius == IntPtr.Zero)
					id_getScatterShapeHoleRadius = JNIEnv.GetMethodID (class_ref, "getScatterShapeHoleRadius", "()F");
				return JNIEnv.CallFloatMethod (((global::Java.Lang.Object) this).Handle, id_getScatterShapeHoleRadius);
			}
		}
...
#pragma warning disable 0169
		static Delegate GetGetScatterShapeSizeHandler ()
		{
			if (cb_getScatterShapeSize == null)
				cb_getScatterShapeSize = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_F) n_GetScatterShapeSize);
...
#pragma warning restore 0169
		...
		IntPtr id_getScatterShapeSize;
		public unsafe float ScatterShapeSize {
			get {
				if (id_getScatterShapeSize == IntPtr.Zero)
					id_getScatterShapeSize = JNIEnv.GetMethodID (class_ref, "getScatterShapeSize", "()F");
				return JNIEnv.CallFloatMethod (((global::Java.Lang.Object) this).Handle, id_getScatterShapeSize);
			}
		}
...
#pragma warning disable 0169
		static Delegate GetGetShapeRendererHandler ()
		{
			if (cb_getShapeRenderer == null)
				cb_getShapeRenderer = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_GetShapeRenderer);
...
#pragma warning restore 0169
		...
		IntPtr id_getShapeRenderer;
		public unsafe global::MikePhil.Charting.Renderer.Scatter.IShapeRenderer ShapeRenderer {
			get {
				if (id_getShapeRenderer == IntPtr.Zero)
					id_getShapeRenderer = JNIEnv.GetMethodID (class_ref, "getShapeRenderer", "()Lcom/github/mikephil/charting/renderer/scatter/IShapeRenderer;");
				return global::Java.Lang.Object.GetObject<global::MikePhil.Charting.Renderer.Scatter.IShapeRenderer> (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_getShapeRenderer), JniHandleOwnership.TransferLocalRef);
			}
		}
