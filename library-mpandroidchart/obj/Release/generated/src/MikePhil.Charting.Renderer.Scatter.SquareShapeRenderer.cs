...
namespace MikePhil.Charting.Renderer.Scatter {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.github.mikephil.charting.renderer.scatter']/class[@name='SquareShapeRenderer']"
	[global::Android.Runtime.Register ("com/github/mikephil/charting/renderer/scatter/SquareShapeRenderer", DoNotGenerateAcw=true)]
	public partial class SquareShapeRenderer : global::Java.Lang.Object, global::MikePhil.Charting.Renderer.Scatter.IShapeRenderer {

		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("com/github/mikephil/charting/renderer/scatter/SquareShapeRenderer", typeof (SquareShapeRenderer));
		...
		protected SquareShapeRenderer (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.github.mikephil.charting.renderer.scatter']/class[@name='SquareShapeRenderer']/constructor[@name='SquareShapeRenderer' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe SquareShapeRenderer ()
...
#pragma warning disable 0169
		...
		{
			global::MikePhil.Charting.Renderer.Scatter.SquareShapeRenderer __this = global::Java.Lang.Object.GetObject<global::MikePhil.Charting.Renderer.Scatter.SquareShapeRenderer> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
