...
namespace MikePhil.Charting.Interfaces.Datasets {
	...
	public partial interface IDataSet : IJavaObject, IJavaPeerable {
		global::MikePhil.Charting.Components.YAxis.AxisDependency AxisDependency {
			...
			[Register ("getAxisDependency", "()Lcom/github/mikephil/charting/components/YAxis$AxisDependency;", "GetGetAxisDependencyHandler:MikePhil.Charting.Interfaces.Datasets.IDataSetInvoker, library-mpandroidchart")]
			get; 
			...
			[Register ("setAxisDependency", "(Lcom/github/mikephil/charting/components/YAxis$AxisDependency;)V", "GetSetAxisDependency_Lcom_github_mikephil_charting_components_YAxis_AxisDependency_Handler:MikePhil.Charting.Interfaces.Datasets.IDataSetInvoker, library-mpandroidchart")]
			set; 
		}
		...
		int Color {
			...
			[Register ("getColor", "()I", "GetGetColorHandler:MikePhil.Charting.Interfaces.Datasets.IDataSetInvoker, library-mpandroidchart")]
			get; 
		}
		...
		global::System.Collections.Generic.IList<global::Java.Lang.Integer> Colors {
			...
			[Register ("getColors", "()Ljava/util/List;", "GetGetColorsHandler:MikePhil.Charting.Interfaces.Datasets.IDataSetInvoker, library-mpandroidchart")]
			get; 
		}
		...
		int EntryCount {
			...
			[Register ("getEntryCount", "()I", "GetGetEntryCountHandler:MikePhil.Charting.Interfaces.Datasets.IDataSetInvoker, library-mpandroidchart")]
			get; 
		}
		...
		global::MikePhil.Charting.Components.Legend.LegendForm Form {
			...
			[Register ("getForm", "()Lcom/github/mikephil/charting/components/Legend$LegendForm;", "GetGetFormHandler:MikePhil.Charting.Interfaces.Datasets.IDataSetInvoker, library-mpandroidchart")]
			get; 
		}
		...
		global::Android.Graphics.DashPathEffect FormLineDashEffect {
			...
			[Register ("getFormLineDashEffect", "()Landroid/graphics/DashPathEffect;", "GetGetFormLineDashEffectHandler:MikePhil.Charting.Interfaces.Datasets.IDataSetInvoker, library-mpandroidchart")]
			get; 
		}
		...
		float FormLineWidth {
			...
			[Register ("getFormLineWidth", "()F", "GetGetFormLineWidthHandler:MikePhil.Charting.Interfaces.Datasets.IDataSetInvoker, library-mpandroidchart")]
			get; 
		}
		...
		float FormSize {
			...
			[Register ("getFormSize", "()F", "GetGetFormSizeHandler:MikePhil.Charting.Interfaces.Datasets.IDataSetInvoker, library-mpandroidchart")]
			get; 
		}
		...
		global::MikePhil.Charting.Model.GradientColor GradientColor {
			...
			[Register ("getGradientColor", "()Lcom/github/mikephil/charting/model/GradientColor;", "GetGetGradientColorHandler:MikePhil.Charting.Interfaces.Datasets.IDataSetInvoker, library-mpandroidchart")]
			get; 
		}
		...
		global::System.Collections.Generic.IList<global::MikePhil.Charting.Model.GradientColor> GradientColors {
			...
			[Register ("getGradientColors", "()Ljava/util/List;", "GetGetGradientColorsHandler:MikePhil.Charting.Interfaces.Datasets.IDataSetInvoker, library-mpandroidchart")]
			get; 
		}
		...
		bool HighlightEnabled {
			...
			[Register ("isHighlightEnabled", "()Z", "GetIsHighlightEnabledHandler:MikePhil.Charting.Interfaces.Datasets.IDataSetInvoker, library-mpandroidchart")]
			get; 
			...
			[Register ("setHighlightEnabled", "(Z)V", "GetSetHighlightEnabled_ZHandler:MikePhil.Charting.Interfaces.Datasets.IDataSetInvoker, library-mpandroidchart")]
			set; 
		}
		...
		global::MikePhil.Charting.Util.MPPointF IconsOffset {
			...
			[Register ("getIconsOffset", "()Lcom/github/mikephil/charting/utils/MPPointF;", "GetGetIconsOffsetHandler:MikePhil.Charting.Interfaces.Datasets.IDataSetInvoker, library-mpandroidchart")]
			get; 
			...
			[Register ("setIconsOffset", "(Lcom/github/mikephil/charting/utils/MPPointF;)V", "GetSetIconsOffset_Lcom_github_mikephil_charting_utils_MPPointF_Handler:MikePhil.Charting.Interfaces.Datasets.IDataSetInvoker, library-mpandroidchart")]
			set; 
		}
		...
		bool IsDrawIconsEnabled {
			...
			[Register ("isDrawIconsEnabled", "()Z", "GetIsDrawIconsEnabledHandler:MikePhil.Charting.Interfaces.Datasets.IDataSetInvoker, library-mpandroidchart")]
			get; 
		}
		...
		bool IsDrawValuesEnabled {
			...
			[Register ("isDrawValuesEnabled", "()Z", "GetIsDrawValuesEnabledHandler:MikePhil.Charting.Interfaces.Datasets.IDataSetInvoker, library-mpandroidchart")]
			get; 
		}
		...
		string Label {
			...
			[Register ("getLabel", "()Ljava/lang/String;", "GetGetLabelHandler:MikePhil.Charting.Interfaces.Datasets.IDataSetInvoker, library-mpandroidchart")]
			get; 
			...
			[Register ("setLabel", "(Ljava/lang/String;)V", "GetSetLabel_Ljava_lang_String_Handler:MikePhil.Charting.Interfaces.Datasets.IDataSetInvoker, library-mpandroidchart")]
			set; 
		}
		...
		global::MikePhil.Charting.Formatter.IValueFormatter ValueFormatter {
			...
			[Register ("getValueFormatter", "()Lcom/github/mikephil/charting/formatter/IValueFormatter;", "GetGetValueFormatterHandler:MikePhil.Charting.Interfaces.Datasets.IDataSetInvoker, library-mpandroidchart")]
			get; 
			...
			[Register ("setValueFormatter", "(Lcom/github/mikephil/charting/formatter/IValueFormatter;)V", "GetSetValueFormatter_Lcom_github_mikephil_charting_formatter_IValueFormatter_Handler:MikePhil.Charting.Interfaces.Datasets.IDataSetInvoker, library-mpandroidchart")]
			set; 
		}
		...
		int ValueTextColor {
			...
			[Register ("getValueTextColor", "()I", "GetGetValueTextColorHandler:MikePhil.Charting.Interfaces.Datasets.IDataSetInvoker, library-mpandroidchart")]
			get; 
			...
			[Register ("setValueTextColor", "(I)V", "GetSetValueTextColor_IHandler:MikePhil.Charting.Interfaces.Datasets.IDataSetInvoker, library-mpandroidchart")]
			set; 
		}
		...
		float ValueTextSize {
			...
			[Register ("getValueTextSize", "()F", "GetGetValueTextSizeHandler:MikePhil.Charting.Interfaces.Datasets.IDataSetInvoker, library-mpandroidchart")]
			get; 
			...
			[Register ("setValueTextSize", "(F)V", "GetSetValueTextSize_FHandler:MikePhil.Charting.Interfaces.Datasets.IDataSetInvoker, library-mpandroidchart")]
			set; 
		}
		...
		global::Android.Graphics.Typeface ValueTypeface {
			...
			[Register ("getValueTypeface", "()Landroid/graphics/Typeface;", "GetGetValueTypefaceHandler:MikePhil.Charting.Interfaces.Datasets.IDataSetInvoker, library-mpandroidchart")]
			get; 
			...
			[Register ("setValueTypeface", "(Landroid/graphics/Typeface;)V", "GetSetValueTypeface_Landroid_graphics_Typeface_Handler:MikePhil.Charting.Interfaces.Datasets.IDataSetInvoker, library-mpandroidchart")]
			set; 
		}
		...
		bool Visible {
			...
			[Register ("isVisible", "()Z", "GetIsVisibleHandler:MikePhil.Charting.Interfaces.Datasets.IDataSetInvoker, library-mpandroidchart")]
			get; 
			...
			[Register ("setVisible", "(Z)V", "GetSetVisible_ZHandler:MikePhil.Charting.Interfaces.Datasets.IDataSetInvoker, library-mpandroidchart")]
			set; 
		}
		...
		float XMax {
			...
			[Register ("getXMax", "()F", "GetGetXMaxHandler:MikePhil.Charting.Interfaces.Datasets.IDataSetInvoker, library-mpandroidchart")]
			get; 
		}
		...
		float XMin {
			...
			[Register ("getXMin", "()F", "GetGetXMinHandler:MikePhil.Charting.Interfaces.Datasets.IDataSetInvoker, library-mpandroidchart")]
			get; 
		}
		...
		float YMax {
			...
			[Register ("getYMax", "()F", "GetGetYMaxHandler:MikePhil.Charting.Interfaces.Datasets.IDataSetInvoker, library-mpandroidchart")]
			get; 
		}
		...
		float YMin {
			...
			[Register ("getYMin", "()F", "GetGetYMinHandler:MikePhil.Charting.Interfaces.Datasets.IDataSetInvoker, library-mpandroidchart")]
			get; 
		}
	...
	internal partial class IDataSetInvoker : global::Java.Lang.Object, IDataSet {
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException ($"Unable to convert instance of type '{JNIEnv.GetClassNameFromInstance (handle)}' to type 'com.github.mikephil.charting.interfaces.datasets.IDataSet'.");
			return handle;
		}
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::MikePhil.Charting.Interfaces.Datasets.IDataSet> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
