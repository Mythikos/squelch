...
namespace MikePhil.Charting.Interfaces.Datasets {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='com.github.mikephil.charting.interfaces.datasets']/interface[@name='ILineRadarDataSet']"
	[Register ("com/github/mikephil/charting/interfaces/datasets/ILineRadarDataSet", "", "MikePhil.Charting.Interfaces.Datasets.ILineRadarDataSetInvoker")]
	[global::Java.Interop.JavaTypeParameters (new string [] {"T extends com.github.mikephil.charting.data.Entry"})]
	public partial interface ILineRadarDataSet : global::MikePhil.Charting.Interfaces.Datasets.ILineScatterCandleRadarDataSet {

		int FillAlpha {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.github.mikephil.charting.interfaces.datasets']/interface[@name='ILineRadarDataSet']/method[@name='getFillAlpha' and count(parameter)=0]"
			[Register ("getFillAlpha", "()I", "GetGetFillAlphaHandler:MikePhil.Charting.Interfaces.Datasets.ILineRadarDataSetInvoker, library-mpandroidchart")] get;
		}

		int FillColor {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.github.mikephil.charting.interfaces.datasets']/interface[@name='ILineRadarDataSet']/method[@name='getFillColor' and count(parameter)=0]"
			[Register ("getFillColor", "()I", "GetGetFillColorHandler:MikePhil.Charting.Interfaces.Datasets.ILineRadarDataSetInvoker, library-mpandroidchart")] get;
		}

		global::Android.Graphics.Drawables.Drawable FillDrawable {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.github.mikephil.charting.interfaces.datasets']/interface[@name='ILineRadarDataSet']/method[@name='getFillDrawable' and count(parameter)=0]"
			[Register ("getFillDrawable", "()Landroid/graphics/drawable/Drawable;", "GetGetFillDrawableHandler:MikePhil.Charting.Interfaces.Datasets.ILineRadarDataSetInvoker, library-mpandroidchart")] get;
		}

		bool IsDrawFilledEnabled {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.github.mikephil.charting.interfaces.datasets']/interface[@name='ILineRadarDataSet']/method[@name='isDrawFilledEnabled' and count(parameter)=0]"
			[Register ("isDrawFilledEnabled", "()Z", "GetIsDrawFilledEnabledHandler:MikePhil.Charting.Interfaces.Datasets.ILineRadarDataSetInvoker, library-mpandroidchart")] get;
		}

		float LineWidth {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.github.mikephil.charting.interfaces.datasets']/interface[@name='ILineRadarDataSet']/method[@name='getLineWidth' and count(parameter)=0]"
			[Register ("getLineWidth", "()F", "GetGetLineWidthHandler:MikePhil.Charting.Interfaces.Datasets.ILineRadarDataSetInvoker, library-mpandroidchart")] get;
		}

		// Metadata.xml XPath method reference: path="/api/package[@name='com.github.mikephil.charting.interfaces.datasets']/interface[@name='ILineRadarDataSet']/method[@name='setDrawFilled' and count(parameter)=1 and parameter[1][@type='boolean']]"
		[Register ("setDrawFilled", "(Z)V", "GetSetDrawFilled_ZHandler:MikePhil.Charting.Interfaces.Datasets.ILineRadarDataSetInvoker, library-mpandroidchart")]
		void SetDrawFilled (bool p0);
	...
	internal partial class ILineRadarDataSetInvoker : global::Java.Lang.Object, ILineRadarDataSet {
		...
		public static ILineRadarDataSet GetObject (IntPtr handle, JniHandleOwnership transfer)
		{
			return global::Java.Lang.Object.GetObject<ILineRadarDataSet> (handle, transfer);
		}
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "com.github.mikephil.charting.interfaces.datasets.ILineRadarDataSet"));
			return handle;
		}
		...
		public ILineRadarDataSetInvoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
		{
...
#pragma warning disable 0169
		...
		{
			global::MikePhil.Charting.Interfaces.Datasets.ILineRadarDataSet __this = global::Java.Lang.Object.GetObject<global::MikePhil.Charting.Interfaces.Datasets.ILineRadarDataSet> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
