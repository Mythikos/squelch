...
namespace MikePhil.Charting.Interfaces.Datasets {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='com.github.mikephil.charting.interfaces.datasets']/interface[@name='IRadarDataSet']"
	[Register ("com/github/mikephil/charting/interfaces/datasets/IRadarDataSet", "", "MikePhil.Charting.Interfaces.Datasets.IRadarDataSetInvoker")]
	public partial interface IRadarDataSet : global::MikePhil.Charting.Interfaces.Datasets.ILineRadarDataSet {

		bool DrawHighlightCircleEnabled {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.github.mikephil.charting.interfaces.datasets']/interface[@name='IRadarDataSet']/method[@name='isDrawHighlightCircleEnabled' and count(parameter)=0]"
			[Register ("isDrawHighlightCircleEnabled", "()Z", "GetIsDrawHighlightCircleEnabledHandler:MikePhil.Charting.Interfaces.Datasets.IRadarDataSetInvoker, library-mpandroidchart")] get;
			// Metadata.xml XPath method reference: path="/api/package[@name='com.github.mikephil.charting.interfaces.datasets']/interface[@name='IRadarDataSet']/method[@name='setDrawHighlightCircleEnabled' and count(parameter)=1 and parameter[1][@type='boolean']]"
			[Register ("setDrawHighlightCircleEnabled", "(Z)V", "GetSetDrawHighlightCircleEnabled_ZHandler:MikePhil.Charting.Interfaces.Datasets.IRadarDataSetInvoker, library-mpandroidchart")] set;
		}

		int HighlightCircleFillColor {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.github.mikephil.charting.interfaces.datasets']/interface[@name='IRadarDataSet']/method[@name='getHighlightCircleFillColor' and count(parameter)=0]"
			[Register ("getHighlightCircleFillColor", "()I", "GetGetHighlightCircleFillColorHandler:MikePhil.Charting.Interfaces.Datasets.IRadarDataSetInvoker, library-mpandroidchart")] get;
		}

		float HighlightCircleInnerRadius {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.github.mikephil.charting.interfaces.datasets']/interface[@name='IRadarDataSet']/method[@name='getHighlightCircleInnerRadius' and count(parameter)=0]"
			[Register ("getHighlightCircleInnerRadius", "()F", "GetGetHighlightCircleInnerRadiusHandler:MikePhil.Charting.Interfaces.Datasets.IRadarDataSetInvoker, library-mpandroidchart")] get;
		}

		float HighlightCircleOuterRadius {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.github.mikephil.charting.interfaces.datasets']/interface[@name='IRadarDataSet']/method[@name='getHighlightCircleOuterRadius' and count(parameter)=0]"
			[Register ("getHighlightCircleOuterRadius", "()F", "GetGetHighlightCircleOuterRadiusHandler:MikePhil.Charting.Interfaces.Datasets.IRadarDataSetInvoker, library-mpandroidchart")] get;
		}

		int HighlightCircleStrokeAlpha {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.github.mikephil.charting.interfaces.datasets']/interface[@name='IRadarDataSet']/method[@name='getHighlightCircleStrokeAlpha' and count(parameter)=0]"
			[Register ("getHighlightCircleStrokeAlpha", "()I", "GetGetHighlightCircleStrokeAlphaHandler:MikePhil.Charting.Interfaces.Datasets.IRadarDataSetInvoker, library-mpandroidchart")] get;
		}

		int HighlightCircleStrokeColor {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.github.mikephil.charting.interfaces.datasets']/interface[@name='IRadarDataSet']/method[@name='getHighlightCircleStrokeColor' and count(parameter)=0]"
			[Register ("getHighlightCircleStrokeColor", "()I", "GetGetHighlightCircleStrokeColorHandler:MikePhil.Charting.Interfaces.Datasets.IRadarDataSetInvoker, library-mpandroidchart")] get;
		}

		float HighlightCircleStrokeWidth {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.github.mikephil.charting.interfaces.datasets']/interface[@name='IRadarDataSet']/method[@name='getHighlightCircleStrokeWidth' and count(parameter)=0]"
			[Register ("getHighlightCircleStrokeWidth", "()F", "GetGetHighlightCircleStrokeWidthHandler:MikePhil.Charting.Interfaces.Datasets.IRadarDataSetInvoker, library-mpandroidchart")] get;
		}
	...
	internal class IRadarDataSetInvoker : global::Java.Lang.Object, IRadarDataSet {
		...
		public static IRadarDataSet GetObject (IntPtr handle, JniHandleOwnership transfer)
		{
			return global::Java.Lang.Object.GetObject<IRadarDataSet> (handle, transfer);
		}
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "com.github.mikephil.charting.interfaces.datasets.IRadarDataSet"));
			return handle;
		}
		...
		public IRadarDataSetInvoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
		{
...
#pragma warning disable 0169
		...
		{
			global::MikePhil.Charting.Interfaces.Datasets.IRadarDataSet __this = global::Java.Lang.Object.GetObject<global::MikePhil.Charting.Interfaces.Datasets.IRadarDataSet> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning disable 0169
		...
		static void n_SetDrawHighlightCircleEnabled_Z (IntPtr jnienv, IntPtr native__this, bool p0)
		{
			global::MikePhil.Charting.Interfaces.Datasets.IRadarDataSet __this = global::Java.Lang.Object.GetObject<global::MikePhil.Charting.Interfaces.Datasets.IRadarDataSet> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.DrawHighlightCircleEnabled = p0;
		}
#pragma warning restore 0169

		IntPtr id_isDrawHighlightCircleEnabled;
		IntPtr id_setDrawHighlightCircleEnabled_Z;
		public unsafe bool DrawHighlightCircleEnabled {
			get {
				if (id_isDrawHighlightCircleEnabled == IntPtr.Zero)
					id_isDrawHighlightCircleEnabled = JNIEnv.GetMethodID (class_ref, "isDrawHighlightCircleEnabled", "()Z");
				return JNIEnv.CallBooleanMethod (((global::Java.Lang.Object) this).Handle, id_isDrawHighlightCircleEnabled);
			}
			set {
				if (id_setDrawHighlightCircleEnabled_Z == IntPtr.Zero)
					id_setDrawHighlightCircleEnabled_Z = JNIEnv.GetMethodID (class_ref, "setDrawHighlightCircleEnabled", "(Z)V");
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (value);
				JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_setDrawHighlightCircleEnabled_Z, __args);
			}
		}
...
#pragma warning restore 0169
		...
		IntPtr id_getHighlightCircleFillColor;
		public unsafe int HighlightCircleFillColor {
			get {
				if (id_getHighlightCircleFillColor == IntPtr.Zero)
					id_getHighlightCircleFillColor = JNIEnv.GetMethodID (class_ref, "getHighlightCircleFillColor", "()I");
				return JNIEnv.CallIntMethod (((global::Java.Lang.Object) this).Handle, id_getHighlightCircleFillColor);
			}
		}
...
#pragma warning restore 0169
		...
		IntPtr id_getHighlightCircleInnerRadius;
		public unsafe float HighlightCircleInnerRadius {
			get {
				if (id_getHighlightCircleInnerRadius == IntPtr.Zero)
					id_getHighlightCircleInnerRadius = JNIEnv.GetMethodID (class_ref, "getHighlightCircleInnerRadius", "()F");
				return JNIEnv.CallFloatMethod (((global::Java.Lang.Object) this).Handle, id_getHighlightCircleInnerRadius);
			}
		}
...
#pragma warning restore 0169
		...
		IntPtr id_getHighlightCircleOuterRadius;
		public unsafe float HighlightCircleOuterRadius {
			get {
				if (id_getHighlightCircleOuterRadius == IntPtr.Zero)
					id_getHighlightCircleOuterRadius = JNIEnv.GetMethodID (class_ref, "getHighlightCircleOuterRadius", "()F");
				return JNIEnv.CallFloatMethod (((global::Java.Lang.Object) this).Handle, id_getHighlightCircleOuterRadius);
			}
		}
...
#pragma warning restore 0169
		...
		IntPtr id_getHighlightCircleStrokeAlpha;
		public unsafe int HighlightCircleStrokeAlpha {
			get {
				if (id_getHighlightCircleStrokeAlpha == IntPtr.Zero)
					id_getHighlightCircleStrokeAlpha = JNIEnv.GetMethodID (class_ref, "getHighlightCircleStrokeAlpha", "()I");
				return JNIEnv.CallIntMethod (((global::Java.Lang.Object) this).Handle, id_getHighlightCircleStrokeAlpha);
			}
		}
...
#pragma warning restore 0169
		...
		IntPtr id_getHighlightCircleStrokeColor;
		public unsafe int HighlightCircleStrokeColor {
			get {
				if (id_getHighlightCircleStrokeColor == IntPtr.Zero)
					id_getHighlightCircleStrokeColor = JNIEnv.GetMethodID (class_ref, "getHighlightCircleStrokeColor", "()I");
				return JNIEnv.CallIntMethod (((global::Java.Lang.Object) this).Handle, id_getHighlightCircleStrokeColor);
			}
		}
...
#pragma warning restore 0169
		...
		IntPtr id_getHighlightCircleStrokeWidth;
		public unsafe float HighlightCircleStrokeWidth {
			get {
				if (id_getHighlightCircleStrokeWidth == IntPtr.Zero)
					id_getHighlightCircleStrokeWidth = JNIEnv.GetMethodID (class_ref, "getHighlightCircleStrokeWidth", "()F");
				return JNIEnv.CallFloatMethod (((global::Java.Lang.Object) this).Handle, id_getHighlightCircleStrokeWidth);
			}
		}
