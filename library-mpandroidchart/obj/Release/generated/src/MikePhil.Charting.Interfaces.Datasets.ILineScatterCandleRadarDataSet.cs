...
namespace MikePhil.Charting.Interfaces.Datasets {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='com.github.mikephil.charting.interfaces.datasets']/interface[@name='ILineScatterCandleRadarDataSet']"
	[Register ("com/github/mikephil/charting/interfaces/datasets/ILineScatterCandleRadarDataSet", "", "MikePhil.Charting.Interfaces.Datasets.ILineScatterCandleRadarDataSetInvoker")]
	[global::Java.Interop.JavaTypeParameters (new string [] {"T extends com.github.mikephil.charting.data.Entry"})]
	public partial interface ILineScatterCandleRadarDataSet : global::MikePhil.Charting.Interfaces.Datasets.IBarLineScatterCandleBubbleDataSet {

		global::Android.Graphics.DashPathEffect DashPathEffectHighlight {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.github.mikephil.charting.interfaces.datasets']/interface[@name='ILineScatterCandleRadarDataSet']/method[@name='getDashPathEffectHighlight' and count(parameter)=0]"
			[Register ("getDashPathEffectHighlight", "()Landroid/graphics/DashPathEffect;", "GetGetDashPathEffectHighlightHandler:MikePhil.Charting.Interfaces.Datasets.ILineScatterCandleRadarDataSetInvoker, library-mpandroidchart")] get;
		}

		float HighlightLineWidth {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.github.mikephil.charting.interfaces.datasets']/interface[@name='ILineScatterCandleRadarDataSet']/method[@name='getHighlightLineWidth' and count(parameter)=0]"
			[Register ("getHighlightLineWidth", "()F", "GetGetHighlightLineWidthHandler:MikePhil.Charting.Interfaces.Datasets.ILineScatterCandleRadarDataSetInvoker, library-mpandroidchart")] get;
		}

		bool IsHorizontalHighlightIndicatorEnabled {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.github.mikephil.charting.interfaces.datasets']/interface[@name='ILineScatterCandleRadarDataSet']/method[@name='isHorizontalHighlightIndicatorEnabled' and count(parameter)=0]"
			[Register ("isHorizontalHighlightIndicatorEnabled", "()Z", "GetIsHorizontalHighlightIndicatorEnabledHandler:MikePhil.Charting.Interfaces.Datasets.ILineScatterCandleRadarDataSetInvoker, library-mpandroidchart")] get;
		}

		bool IsVerticalHighlightIndicatorEnabled {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.github.mikephil.charting.interfaces.datasets']/interface[@name='ILineScatterCandleRadarDataSet']/method[@name='isVerticalHighlightIndicatorEnabled' and count(parameter)=0]"
			[Register ("isVerticalHighlightIndicatorEnabled", "()Z", "GetIsVerticalHighlightIndicatorEnabledHandler:MikePhil.Charting.Interfaces.Datasets.ILineScatterCandleRadarDataSetInvoker, library-mpandroidchart")] get;
		}
	...
	internal partial class ILineScatterCandleRadarDataSetInvoker : global::Java.Lang.Object, ILineScatterCandleRadarDataSet {
		...
		public static ILineScatterCandleRadarDataSet GetObject (IntPtr handle, JniHandleOwnership transfer)
		{
			return global::Java.Lang.Object.GetObject<ILineScatterCandleRadarDataSet> (handle, transfer);
		}
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "com.github.mikephil.charting.interfaces.datasets.ILineScatterCandleRadarDataSet"));
			return handle;
		}
		...
		public ILineScatterCandleRadarDataSetInvoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
		{
...
#pragma warning disable 0169
		...
		{
			global::MikePhil.Charting.Interfaces.Datasets.ILineScatterCandleRadarDataSet __this = global::Java.Lang.Object.GetObject<global::MikePhil.Charting.Interfaces.Datasets.ILineScatterCandleRadarDataSet> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
