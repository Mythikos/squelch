...
public class UIApplicationListAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Squelch.Library.UI.UIApplicationListAdapter, Squelch", UIApplicationListAdapter.class, __md_methods);
	}


	public UIApplicationListAdapter ()
	{
		super ();
		if (getClass () == UIApplicationListAdapter.class)
			mono.android.TypeManager.Activate ("Squelch.Library.UI.UIApplicationListAdapter, Squelch", "", this, new java.lang.Object[] {  });
	}
